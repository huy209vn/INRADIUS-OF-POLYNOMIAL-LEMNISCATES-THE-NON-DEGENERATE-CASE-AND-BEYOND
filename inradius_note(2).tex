...
three or more roots, and reduce the full conjecture to the
...
%% --------------------------------------------------
\subsection{A structural obstruction for $k \geq 3$}
\label{sec:obstruction}
%% --------------------------------------------------

For $k = 2$, the Blaschke product has a unique critical point $w_c$,
and direct computation shows that $\abs{B''(w_c)}(1-\abs{w_c}^2)^2 = 2$
universally.  Combined with~\eqref{eq:lhopital} and a bound on
$\abs{P''(\zeta_c)}$, this closes the argument for two-root components.

For $k \geq 3$, however, we find a fundamental obstruction.
...
cannot yield a universal bound for $k \geq 3$.
...
\begin{enumerate}[(i)]
  \item The Blaschke critical-point invariants degenerate for
    $k \geq 3$ (Section~\ref{sec:obstruction}), preventing
